...
<head>
    ...
    <style>
        ...
        .main-content {
            margin-top: 140px; /* Adjusted for the smaller header */
            display: flex;
            flex-direction: column;
            align-items: center;
            padding: 20px;
...
?>
    ...
    <script>
                ...
                .then(categories => {
                    ...
                    filteredCategories.forEach(category => {
                        ...
                        categoryItem.innerHTML = `
                            <a href="/stationery/admin/manageItems.php?category=${encodeURIComponent(category.title)}">
        ...
        // Update the populateCategories function for admin-specific features
            ...
            fetch('/stationery/fetchFunction/fetchCategories.php')
                ...
                .then(categories => {
                    categories.forEach(category => {
                        ...
                        // Add admin-specific link to manage items
                        categoryItem.innerHTML = `
                            <a href="/stationery/admin/manageItems.php?category=${encodeURIComponent(category.title)}">
                                <div class="category-image-container">
                                    <img src="${category.image_path || '/stationery/images/default-category.jpg'}" 
